...
\definecolor{awesome}{HTML}{f75e33}
...
% \photo{./5050669.jpg}
\name{Luís}{Ferreira}
\position{Developer{\enskip\cdotp\enskip}Computer Science \& Software Engineering}

\email{contact@lsferreira.net}
\homepage{www.lsferreira.net}
\github{ljmf00}
\linkedin{ljmf00}
\gitlab{lsferreira}
...
\makecvfooter
  {\today}
  {Luís Ferreira~~~·~~~Curriculum Vitae}
  {\thepage}
